...
Foundry VTT v13 module for DnD5e 5.2.4 that tracks shared reputation-building (or anything else you want to track with progress/phases and skill checks really) during downtime. 
